...
ZC1ZCspikezm0zi1zi0zi0zminplacezmspikeZCSpikeZC: async ($1,$2) => (((ws, cb) => { ws.onopen = cb; })),
ZC3ZCspikezm0zi1zi0zi0zminplacezmspikeZCSpikeZC: ($1) => ((...args) => __exports.ghczuwasmzujsffiZC2ZCspikezm0zi1zi0zi0zminplacezmspikeZCSpikeZC($1, ...args)),
ZC4ZCspikezm0zi1zi0zi0zminplacezmspikeZCSpikeZC: async ($1) => (((url) => new WebSocket(url))),
ZC5ZCspikezm0zi1zi0zi0zminplacezmspikeZCSpikeZC: async ($1) => (((s) => { document.getElementById('log').innerText += s + '\n'; })),
