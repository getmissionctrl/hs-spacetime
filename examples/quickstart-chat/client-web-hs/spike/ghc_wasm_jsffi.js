...
ZC1ZCspikezm0zi1zi0zi0zminplacezmspikeZCSpikeZC: async ($1,$2) => (((cb, ms) => { setTimeout(cb, ms); })),
ZC2ZCspikezm0zi1zi0zi0zminplacezmspikeZCSpikeZC: async ($1,$2) => (((ws, cb) => { ws.onerror = cb; ws.onclose = cb; })),
ZC3ZCspikezm0zi1zi0zi0zminplacezmspikeZCSpikeZC: async ($1,$2) => (((ws, cb) => { ws.onopen = cb; })),
ZC5ZCspikezm0zi1zi0zi0zminplacezmspikeZCSpikeZC: ($1) => ((...args) => __exports.ghczuwasmzujsffiZC4ZCspikezm0zi1zi0zi0zminplacezmspikeZCSpikeZC($1, ...args)),
ZC6ZCspikezm0zi1zi0zi0zminplacezmspikeZCSpikeZC: async ($1) => (((url) => new WebSocket(url))),
